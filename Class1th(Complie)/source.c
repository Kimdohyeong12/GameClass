...
#pragma region 자료형
	...
	//크기는 바이트 단의로 이루어져 있고, 자료형에 따라 저장할
...
#pragma region 변수의 이름 규칙
	...
	// 3. 변수의 이름에는 공백이 포함될수 없습니다.
	// ex) float time Delta;

	// 4.변수의 이름으로 특수 분자는 "_", "$'만 사용할수 있습니다.

	// ex)int under_score;
	// ex)int currenatRoom$;

	// 5. 변수의 이름으로 숫자로 시작할수 없습니다.
